...
class TestRemotionClientDeprecation:
    """All Remotion client methods should emit FutureWarning."""
    ...
    def test_remotion_render_warns(self, mock_render, client):
        ...
        with pytest.warns(FutureWarning, match="Remotion is deprecated"):
...
class TestRemotionServerToolDeprecation:
    """Remotion MCP server tools should emit FutureWarning."""
