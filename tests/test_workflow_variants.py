...
def test_variants_do_not_change_public_surface_counts():
    ...
    assert len(tool_names) == 156  # Variants add none; the shorts product adds five.
...
def test_variant_flags_do_not_add_cli_commands():
    ...
    assert len(set(command_list.split(","))) == 131  # Variants add none; shorts adds one command.
